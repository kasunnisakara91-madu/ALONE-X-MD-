...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://i.ibb.co/TB2Xwpc5/jawadmd.jpg',
  ...
  BOT_VERSION: '8.0.0V',
  OWNER_NAME: 'ALONE-X-MD V8',
  IMAGE_PATH: 'https://i.ibb.co/TB2Xwpc5/jawadmd.jpg',
  BOT_FOOTER: '> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ALONE-X-MD V8.*',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/TB2Xwpc5/jawadmd.jpg' }
};
...
case 'font': {
    try {
        ...
        fancyMsg += `*┕━━━━━━━━━━━━━●►*\n\n\n`;
        fancyMsg += `> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ALONE-X-MD V8🇱🇰*`;
...
// shiya time case ⏩⏩⏩⏩⏩
  ...
  try {
    ...
    const BOT_NAME = 'ALONE-X-MD V8 🇱🇰';
    const OWNER_NAME = 'damith';
    const CHANNEL_LINK = "channel eka dapn";
    const TIME_IMG = "https://i.ibb.co/TB2Xwpc5/jawadmd.jpg";
     ...
     // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗧ɪᴋᴛᴏᴋ 𝗖ᴀꜱᴇ
        ...
        case 'cfn': {
          ...
          if (!jid || !jid.endsWith('@newsletter')) {
            await socket.sendMessage(sender, { text: '❗ Invalid JID. Example: 120363428670000697@newsletter' }, { quoted: msg });
            break;
          }
...
END:VCARD`
 ...
 case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || 'ALONE-X-MD V8 🇱🇰'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
    ...
    const text = `𝐇𝙸 👋 ALONE-X-MD V8 🇱🇰 𝐁𝙾𝚃 𝐔𝚂𝙴𝚁 𝐈 𝐀𝙼 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆 💙
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const currentConfig = await loadUserConfigFromMongo(sanitized) || {};
    const botName = currentConfig.botName || 'ALONE-X-MD V8 🇱🇰'; // Default name fallback
    ...
    const settingOptions = {
      ...
      paramsJson: JSON.stringify({
        title: `ALONE-X-MD 𝐕8.0.0𝙑 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐍𝐄𝐖 💜`,
        sections: [
          {
            title: '📍 ALONE-X-MD 🇱🇰𝐕8--𝙼𝙳 ᴠ.8.0.0 ᴘᴇʀꜱᴏɴᴀʟɪᴢᴀᴛɪᴏɴ',
            highlight_label: 'New',
            rows: [
              { 
          ...
          {
            title: '📍 ALONE-X-MD 𝐕8.0𝙑 ᴛʏᴘᴇ ᴏꜰ ᴡᴏʀᴋ',
            rows: [
          ...
          {
            title: '🫀🐇ALONE-X-MD V8 🇱🇰  ɢʜᴏꜱᴛ & ᴘʀɪᴠᴀᴄʏ',
            rows: [
          ...
          {
            title: '📍 ALONE-X-MD V8 🇱🇰 8.0.0𝙑  ᴀᴜᴛᴏᴍᴀᴛɪᴏɴ & ᴛᴏᴏʟꜱ',
            rows: [
          ...
          {
            title: '📍 ALONE-X-MD V8 🇱🇰 𝐕8.0.0𝙑  ᴍᴇꜱꜱᴀɢᴇ ʜᴀɴᴅʟɪɴɢ',
            rows: [
...
case 'freebot': {
    ...
    try {
        ...
        const mainMsg = `*ALONE-X-MD 8.0.0𝙑  ᴘᴀɪʀ ᴄᴏɴɴᴇᴄᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀ ᴄᴏᴅᴇ :* ${result.code}\n*🌐 ʙᴏᴛ ʟɪɴᴋ :* ${botUrl}\n\n> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ALONE-X-MD V8 🇱🇰*`;
...
`;
        ...
        case 'videop1': {
          ...
          try {
            ...
            const caption = `*🎬 ALONE-X-MD V8 🇱🇰 𝗩ɪᴅᴇᴏ 𝗗ᴏᴡɴʟᴏᴀᴅᴇʀ ??*
...
case 'news': {
          try {
            ...
            const text = `
*𝗛ɪ 👋 ALONE-X-MD V8 🇱🇰 𝗠ɪɴɪ 𝗕ᴏᴛ 𝗨ꜱᴇʀ*
...
`;
            ...
            const buttons = [
              {
                buttonId: 'action',
                buttonText: {
                  displayText: 'ALONE-X-MD V8 🇱🇰 2.0.0𝙑 𝐍𝙴𝚆𝚂 📰'
                },
                type: 4,
                nativeFlowInfo: {
                  name: 'single_select',
                    ...
                    sections: [
                      {
                        ...
                        rows: [
                          {
                            title: 'ᴀᴅᴀɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰_ᴍᴅ ᴀᴅᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}ada`,
                          },
                          {
                            title: 'ʜɪʀᴜ ɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ʜɪʀᴜ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}hiru`,
                          },
                          {
                            title: 'ꜱɪʀᴀꜱᴀ ɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ꜱɪʀᴀꜱᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}sirasa`,
                          },
                          {
                            title: 'ɪᴛɴ ɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ɪᴛɴ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}itn`,
                          },
                          // පස්සෙ කෑල්ල මෙතනට
                          {
                            title: 'ʟɴᴡ ɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰ᴅ ʟɴᴡ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}lnw`,
                          },
                          {
                            title: 'ʙʙᴄ ɴᴇᴡꜱ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ʙʙᴄ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}bbc`,
                          },
                          // මෙතනට ටයිපින්
                          {
                            title: 'ᴅᴀꜱᴀᴛʜᴀ ʟᴀɴᴋᴀ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰ᴅᴀꜱᴀᴛʜᴀ ɴᴡᴇꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}dasathalanka`,
                          },
                          {
                            title: 'ꜱɪʏᴀᴛᴀ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ꜱɪʏᴀᴛʜᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}siyatha`,
                          },
                          // රෙකෝඩින් එක මෙතනට
                          {
                            title: 'ʟᴀɴᴋᴀᴅᴇᴇᴘᴀ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ʟᴀɴᴋᴀᴅᴇᴇᴘᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
                            id: `${config.PREFIX}lankadeepa`,
                          },
                          {
                            title: 'ɢᴀɢᴀɴᴀ 📰',
                            description: 'ALONE-X-MD V8 🇱🇰 ɢᴀɢᴀɴᴀ ɴᴇᴡꜱ ᴜᴘᴅᴀᴛᴇ 📍',
            ...
            await socket.sendMessage(sender, {
              image: imagePayload,
              caption: text,
              footer: `> *𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝐘 ALONE-X-MD V8 🇱🇰𝐕.2 📍📡*`,
              buttons,
              headerType: 4
            }, { quoted: metaQuote });
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "ALONE-X-MD V8 🇱🇰"; // Default Artful Name
        const logo = cfg.logo || "https://i.ibb.co/TB2Xwpc5/jawadmd.jpg"; // Default Logo
...
┕━━━━━━━━━━●►
   ...
   *අඩන්න එපා හලිද profile එක විතරයිනේ ගත්තේ මන් අල ගේනත් දෙන්නම්කො සුදු හලිද 🥺💗 ALONE-X-MD V8 🇱🇰 = owner Eranda 🤌🧚0787940686*
...
case 'madusanka': {
            ...
            const ownerName = 'ALONE-X-MD V8 🇱🇰';
            const organization = '*ALONE-X-MD V8 🇱🇰 𝙱𝙾𝚃 𝙳𝙴𝚅𝙰𝙻𝙾𝙿𝙰𝚁';
   ...
   // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗨ʀʟ 𝗖ᴀꜱᴇ
        ...
        case 'upload': {
          ...
          const metaQuote = {
            ...
            message: { contactMessage: { displayName: "ALONE-X-MD V8 🇱🇰", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Upload Service\nORG:Catbox/ImgBB\nEND:VCARD` } }
          };
    ...
    // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗚ᴊɪᴅ 𝗖ᴀꜱᴇ
        ...
        case 'grouplist': {
          try {
            ...
            const sanitized = (number || '').replace(/[^0-9]/g, '');
            const cfg = await loadUserConfigFromMongo(sanitized) || {};
            const botName = cfg.botName || BOT_NAME_FANCY || "ALONE-X-MD V8 🇱🇰";
...
`;
    ...
    // 𝐀𝚂𝙷𝙸𝚈𝙰-𝐌𝙳 4.0.0𝗩 🥷🇱🇰 𝗝ɪᴅ 𝗖ᴀꜱᴇ
        case 'jid': {
          const sanitized = (number || '').replace(/[^0-9]/g, '');
          const cfg = await loadUserConfigFromMongo(sanitized) || {};
          const botName = cfg.botName || 'ALONE-X-MD V8 🇱🇰'; // dynamic bot name
